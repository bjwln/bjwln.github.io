...
![](<PyTorch 入门—从张量到线性回归/image-20260605101130635.png>)
...
![image-20260614103710271](<PyTorch 入门—从张量到线性回归/image-20260614103710271.png>)

![](<PyTorch 入门—从张量到线性回归/image-20260614103655112.png>)
...
![image-20260614222751340](<PyTorch 入门—从张量到线性回归/image-20260614222751340.png>)
...
![image-20260614223902264](<PyTorch 入门—从张量到线性回归/image-20260614223902264.png>)

![image-20260614223851271](<PyTorch 入门—从张量到线性回归/image-20260614223851271.png>)

关于`t9`：

![image-20260614224332820](<PyTorch 入门—从张量到线性回归/image-20260614224332820.png>)

<span style="color:#FF00FF">⭐这里的二维度相比于前面的维度，只是单个数字，故不用再加中括号</span>

![image-20260614230021539](<PyTorch 入门—从张量到线性回归/image-20260614230021539.png>)

![image-20260614230104952](<PyTorch 入门—从张量到线性回归/image-20260614230104952.png>)
...
![image-20260616222332398](<PyTorch 入门—从张量到线性回归/image-20260616222332398.png>)

![image-20260616223707063](<PyTorch 入门—从张量到线性回归/image-20260616223707063.png>)
...
![image-20260703120004061](<PyTorch 入门—从张量到线性回归/image-20260703120004061.png>)
...
`loss = criterion(y_pred,train_y.reshape(-1,1))`计算预测值和真实值之间的损失，分两部分解释：
  ...
  2. `train_y.reshape(-1, 1)` `# train_y` 从 DataLoader 来，原始 `shape: (16,)`
     ...
     ![image-20260703113328639](<PyTorch 入门—从张量到线性回归/image-20260703113328639.png>)

     ![image-20260703113349286](<PyTorch 入门—从张量到线性回归/image-20260703113349286.png>)
...
![image-20260702161448070](<PyTorch 入门—从张量到线性回归/image-20260702161448070.png>)
...
![image-20260704164257692](<PyTorch 入门—从张量到线性回归/image-20260704164257692.png>)
...
![image-20260704183626622](<PyTorch 入门—从张量到线性回归/image-20260704183626622.png>)

![image-20260704190145254](<PyTorch 入门—从张量到线性回归/image-20260704190145254.png>)
